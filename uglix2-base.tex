...
\newcommand{\bareme}[1]{\hfill {\scriptsize(#1)}}                 % Barème

%_____________________________________________________________________________________________________________________________________________________________________________

%
% \double{texte1}{texte2}{largeur texte 2}
%
\newlength{\Double}
\newcommand{\double}[3]{
	\setlength{\Double}{\columnwidth}
	\addtolength{\Double}{-#3}
	\addtolength{\Double}{-\columnsep} % ou \colseprule
	\begin{minipage}{\Double}
		#1
	\end{minipage}
	\hspace*{\columnsep}
	\begin{minipage}{#3}
